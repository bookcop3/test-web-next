...
const prices = [
  ...
  {
    name: '$10000001 - $20000000',
    value: '10000001-20000000',
  },
  {
    name: '$20000001 - $30000000',
    value: '20000001-30000000',
  },
];
        ...
        <div>
          <div className="my-3">
            ...
            >
              ...
              <option value="all">บ้าน</option>
              <option value="all">คอนโด</option>
              <option value="all">ที่ดิน</option>
          ...
          <div className="my-3">
            ...
            >
              <option value="all">All</option>
              <option value="all">ขาย</option>
              <option value="all">เช่า</option>
              {categories &&
                categories.map((category) => (
                  <option key={category} value={category}>
                    {category}
